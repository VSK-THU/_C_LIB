...
#ifndef HARDWARE_V2012_H
#define	HARDWARE_V2012_H
...
// -----------------------------------------------------------------push buttons
#define BTN_1               PORTBbits.RB2
#define BTN_1_TRI           TRISBbits.TRISB2
#define BTN_2               PORTBbits.RB3
#define BTN_2_TRI           TRISBbits.TRISB3
#define BTN_3               PORTBbits.RB4
#define BTN_3_TRI           TRISBbits.TRISB4
#define BTN_4               PORTBbits.RB5
#define BTN_4_TRI           TRISBbits.TRISB5

#define BTN_ACTIVATED       0
#define mGET_BTN_1()        (BTN_1 == BTN_ACTIVATED)
#define mGET_BTN_2()        (BTN_2 == BTN_ACTIVATED)
#define mGET_BTN_3()        (BTN_3 == BTN_ACTIVATED)
#define mGET_BTN_4()        (BTN_4 == BTN_ACTIVATED)
...
// ---------------------------------------------------------------rotary encoder
#define ENC_BTN         PORTBbits.RB2
#define ENC_BTN_TRI     TRISBbits.TRISB2
#define mGET_BTN_ENC()  (ENC_BTN == BTN_ACTIVATED)
